 ...
 * @ORM\Entity(repositoryClass="App\Repository\Event\EventParticipationRepository")
 */
class EventParticipation
{

    /** @var string */
    const REPOSITORY = 'App:Event\EventParticipation';
     ...
     * @var User
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="eventParticipationList")
