...
namespace Tests\Functional\Security\Registration;
...
use App\Entity\User;
use App\EventSubscriber\User\Registration\FailureListener;
use App\EventSubscriber\User\Registration\InitializeListener;
use App\EventSubscriber\User\Registration\SuccessListener;
use App\DataFixtures\ORM\User\UserSingletonFixtures;
use Tests\Functional\Util\WebTestCase;

/**
 * @package App\Tests\Security\Registration
