...
class User extends BaseUser
{
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Event\EventParticipation", mappedBy="participant", cascade={"remove"})
     */
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Notification\NotificationToUser", mappedBy="user", cascade={"remove"})
     */
