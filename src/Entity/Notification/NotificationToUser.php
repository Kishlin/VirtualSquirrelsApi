 ...
 * @ORM\Entity(repositoryClass="App\Repository\Notification\NotificationToUserRepository")
 *
 * @package App\Entity
...
class NotificationToUser
{
    ...
    /** @var string */
    const REPOSITORY = 'App:NotificationToUser';
     ...
     * @var User
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="notificationToUserList")
